 ...
 * |------+------+------+------+------+------+------+------ |                                      |------+------+------+------+------+------+------+------|
 * |LCTRL |   Z  |   X  |   C  |   D  |   V  |  ]}  |  F13  |                                      |  F5  | PDWN |   K  |   H  |   ,  |   .  |   /? |RShift|
 * `-----------------------------------------------------------/       /               \       \-----------------------------------------------------------'
 ...
 */
 ...
 [_COLDH] = LAYOUT(                                                                                                                                                       
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,    KC_RBRC, KC_F13,                        KC_F5,     KC_PGDN, KC_K,     KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_APP,  KC_LGUI, KC_LALT, KC_SPC,  MO(3),   BackNUM,    TT(2),    MO(3),     KC_BSPC, KC_SFTENT,KC_DEL,  KC_RGUI
),
 ...
 * |------+------+------+------+------+------+------+------ |                                      |------+------+------+------+------+------+------+------|
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |  ]}  |  F13  |                                      |  F5  | PDWN |   N  |   M  |   ,  |   .  |   /? |RShift|
 * `-----------------------------------------------------------/       /               \       \-----------------------------------------------------------'
 *                | MENU  | LGUI  |  LALT  |  Space | Lower | /BackSP /                 \   Num \  | Lower| BackSP|Ent/shft|   DEL  | RGUI  |
 *                |       |       |        |        |       |/       /                   \       \ |      |       |        |        |       |
 *                `-------------------------------------------------'                     '-------------------------------------------------'
 ...
 */
 ...
 [_NUM] = LAYOUT(                                                                                                                                                         
  TO(1),   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                                             KC_HOME, KC_NUM,   KC_P7,   KC_P8,  	KC_P9,   KC_PMNS, KC_MINS,
  ...
  TO(0),   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_F14,                        KC_TRNS,   KC_PGDN, KC_NO,    KC_P0,   KC_PCMM, KC_PDOT, KC_PENT, KC_RSFT,
                             KC_APP,  KC_LGUI, KC_LALT, KC_SPC,  MO(3),   KC_BSPC,    TT(2),    MO(3),     KC_BSPC, KC_SFTENT,KC_DEL,  KC_RGUI
),
 ...
 */
 ...
 [_LOWER] = LAYOUT(                                                                                                                                                       
  ...
  KC_NO,   KC_MSEL, KC_MSTP, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,   KC_F14,                         KC_F15,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  
                             KC_APP,  KC_LGUI, KC_LALT, KC_SPC,  MO(3),   KC_DEL,      TO(2),    MO(3),     KC_BSPC, KC_SFTENT,KC_DEL,  KC_RGUI
),
 [_RAISE] = LAYOUT(                                                                                                                                                       
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV,                                             KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_6,                                               KC_5,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL, 
  KC_LSFT,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_6,                                               KC_5,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_6,                           KC_RBRC,   KC_N,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_APP,  KC_LGUI, KC_LALT, KC_SPC,  MO(3),   KC_DEL,    LT(2,KC_BSPC), MO(4), KC_BSPC, KC_SFTENT,MO(3),   KC_RGUI
),
 [_ADJUST] = LAYOUT(                                                                                                                                                      
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV,                                             KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,    KC_6,                                               KC_5,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL, 
